...
import { getNotes, getNote, createNote, getProduct, getProductVariants, getColors, getSizes, getAllProductVariants, addNewUser } from './database.js'
...
app.post("/registerUser", async (req, res) => {
  console.log("req body:", req.body)
  const user=await addNewUser(req.body.fullName, req.body.email, req.body.password, req.body.gender, req.body.mobile);
